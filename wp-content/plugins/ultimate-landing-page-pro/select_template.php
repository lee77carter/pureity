...
<div id='lpp_wrapper' class='formLayout_s_l'>
    <h2>Select a template and click Update to edit.</h2>
    <div id='lpp_left'>
        ...
        Comingsoon page
        <input type="radio" id='lpp_select_template14' name='lpp_template_select' value='lpp_template_14.php'
        <?php checked( "lpp_template_14.php", $lpp_template_select); ?>
        >
        <label for='lpp_select_template14'>
            <img src="<?php echo plugins_url('/img/landingpage_template_14.png',__FILE__); ?>" style='width:200px;height:200px;' >
        </label>
        ...
        Template - Simple
        <input type="radio" id='lpp_select_templatecs_2' name='lpp_template_select' value='lpp_template_15.php'
        <?php checked( "lpp_template_15.php", $lpp_template_select); ?>
        >

        <label for='lpp_select_templatecs_2'>
            <img src="<?php echo plugins_url('/img/landingpage_template_15.png',__FILE__); ?>" style='width:200px;height:200px;' >
        </label>
...
<div id='lpp_row_3'>
    Template -9
        ...
        <label for='lpp_select_template9'>
         ...
         Template -10
        <input type="radio" id='lpp_select_template10' name='lpp_template_select' value='lpp_template_10.php'
        ...
        Template -11
        <input type="radio" id='lpp_select_template11' name='lpp_template_select' value='lpp_template_12.php'
        <?php checked( "lpp_template_12.php", $lpp_template_select); ?>
        >

        <label for='lpp_select_template11'>
            <img src="<?php echo plugins_url('/img/landingpage_template_12.png',__FILE__); ?>" style='width:200px;height:200px;' >
        </label>

        Template -12
        <input type="radio" id='lpp_select_template13' name='lpp_template_select' value='lpp_template_13.php'
        <?php checked( "lpp_template_13.php", $lpp_template_select); ?>
        >

        <label for='lpp_select_template13'>
            <img src="<?php echo plugins_url('/img/landingpage_template_13.png',__FILE__); ?>" style='width:200px;height:200px;' >
        </label>
        ...
        <label for='lpp_select_template_custom'>
            <img src="<?php echo plugins_url('/img/landingpage_template_custom.png',__FILE__); ?>" style='width:200px;height:200px;' >
        </label>
