...
<body>
    ...
    <div id='lpp_content'>
      ...
      <div id='lpp_center_right'>
          <input id="image_location1" type="text" class="upload_image_button2"  name='lpp_add_img_1' value='<?php echo $lpp_add_img_1; ?>' placeholder='Featured image URL or embed video ' style='font-size:14px; text-align:center;width:80%;height:45%;'/>
