...
?>
<h2>CSS :</h2>
<textarea style='width:400px; height:150px;' name='lpp_custom_styling'  placeholder='Enter your custom styling here.'>
<?php echo $lpp_custom_styling; ?>
</textarea>
<h2>JS :</h2>
<textarea style='width:400px; height:150px;' name='lpp_custom_js'  placeholder='Enter your custom javascript here.'>
