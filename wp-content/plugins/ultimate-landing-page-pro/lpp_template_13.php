	...
	<div id='lpp_section_1' class='lpp_section'>
		...
		<?php
			 ...
			 ?>
				...
				<?php 
				$sh_content = get_post_meta( $post->ID , 'lpp_main_content' , true );
				echo  do_shortcode($sh_content);  ?>
			<p>
				<a href="<?php echo  get_post_meta( $post->ID , 'lpp_cta_url' , true ); ?>"><button type='submit' id='lpp_submit' class='lpp_input'>
