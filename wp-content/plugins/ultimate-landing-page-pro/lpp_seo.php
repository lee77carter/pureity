...
function lpp_seo_set($post){
	...
	<div class='formLayout_2'>
		...
		<textarea type='text' style='height:200px; width:350px; float:left;' name='lpp_seo_meta_description' placeholder='Meta Description :' ><?php echo $lpp_seo_meta_description; ?></textarea>
		<br>
